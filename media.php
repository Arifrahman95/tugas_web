...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Welcome di Weshop Probolinggo</title>
...
<div id="wrapper"> 
    ...
    <div id="header">
        ...
        <div class="logo"><img src="template/images/rar.png" /></div>
...
<div class="plugin">             
    ...
    <div class="page">
        ...
        <div class="copyright">
              <ul>
            <li>&copy; 2020 </li>
            <li><a href="#" class="select"> WESHOP</a> All Rights Reserved.</li>
            <li><a href="http://sedotcode.blogspot.com/" class="select"> Weshop Probolinggo </a> All Rights Reserved.</li>
            <li class="last"></li>
          </ul>
            </div>
